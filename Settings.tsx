...
BEGIN
    ...
    SELECT voucher_date, voucher_no, narration INTO v_date, v_no, v_narration FROM journal_vouchers WHERE id = v_jv_id;
...
DROP TRIGGER IF EXISTS trg_jv_sync ON journal_vouchers;
...
DROP TRIGGER IF EXISTS trg_jv_entries_sync ON journal_voucher_entries;
              ...
              <div className="space-y-12">
                 ...
                 <div className="bg-amber-50 dark:bg-amber-900/10 border border-amber-100 dark:border-amber-900/20 p-6 rounded-2xl flex items-start gap-4">
                    ...
                    <p className="text-xs font-bold text-amber-700 dark:text-amber-400 leading-relaxed">
                      Copy the code above and run it in your Supabase SQL Editor. This fixes the Journal Voucher impact issue.
                    </p>
                 </div>
              </div>
            )}
