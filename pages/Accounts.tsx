  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
        ...
        <button className="bg-[#0B1120] dark:bg-sky-600 hover:bg-slate-800 dark:hover:bg-sky-500 text-white px-8 py-3.5 rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] flex items-center gap-3 shadow-xl transition-all w-full md:w-auto justify-center">
      ...
      <div className="flex items-center justify-between px-10 py-6 text-[9px] font-black text-slate-300 dark:text-slate-600 uppercase tracking-widest">
        <span>Total Accounts Registered: {state.accounts.length}</span>
        <span>Operational Standard: Accounting Core V3.3</span>
      </div>
    </div>
  );
};
